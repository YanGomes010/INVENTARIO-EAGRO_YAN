...
"O controle é normalmente pelo plantio de cultivares mais resistentes, plantio em menor quantidade e por inseticidas.", 
  ...
  var MELANCIAdb = {
    ...
    introducao:
      "A melancia origina-se do continente africano. No Brasil, a cultivar é uma das principais plantas olerícolas produzidas, chegando a 75.795 ha, de área cultivada (IBGE, 2006). Composta de 92,6% de água (EPAGRI, 1996), a melancia pode ser cultivada em regiões secas e também em locais com irrigação. Embora seja uma das olerícolas mais produzidas, a grande maioria dos produtores não possuem alta produtividade nas lavouras, por causa do desprovimento de tecnologia no sistema de plantio.",
    Clima: "CLIMA",
    ...
    Paragrafo_melancia_5:"Para o preparo do solo, recomenda-se aração profunda, gradagem leve e subsolagem e antes da aração (EMBRAPA, XXXX).  Para melhor aproveitamento, as operações devem ser realizadas dois meses antes do plantio, incorporando calcário e magnesio se necessário.",
    Adubacao: "ADUBAÇÃO",
    infoAdubacao:
      "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
    Pragas: "PRAGAS",

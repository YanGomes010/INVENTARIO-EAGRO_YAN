...
"O controle é normalmente pelo plantio de cultivares mais resistentes, plantio em menor quantidade e por inseticidas.", 
  ...
  var MELANCIAdb = {
    ...
    Clima: "CLIMA",
    Paragrafo_melancia_0:"A melancia é uma planta de clima tropical, assim não tolerando geadas e granizo, nem baixas temperaturas contantes. A cultivar se adapta muito bem a regiões quentes e semi-áridas, exposição a luz abaixo de 30°C , que possibilitam melhor desenvolvimento. Caso a temperatura seja muito alta (acima de 36°C) ou muito baixa (abaixo de 16°C), o crescimento é paralisado, consequentemente afetando a formação de flores, causando a produção de frutos desuniformes e pequenos (EMBRAPA,2007).",
    Paragrafo_melancia_1:" A temperatura ideal que favorece o crescimento da cultura, situa-se entre 23° e 30°C, caso a temperatura se mantenha próxima a 30°C, a germinação será acelerada, podendo chegar a ocorrer em apenas 5 dias (EMBRAPA, 2006). A fase inicial é importante, pois o vigor é maior, assim possibilitando grande número de flores femininas na planta, logo, aumentando a quantidade frutos (EMBRAPA,2007).",
    Paragrafo_melancia_2:"Por ser rasteira, ventos fortes e atrito com matérias sólidas, provocam danos na planta, assim favorecendo a aparição de fungos e bactérias. Para evitar esse tipo de lesões, o preparo do solo não pode ser intenso e devem ser mantidos torrões para melhor fixação das ramas.",
    Paragrafo_melancia_3:"Em regiões secas o estresse hídrico é comum, logo a presença de irrigação é imprescindível para que não ocorram falhas durante o florescimento e frutificação. Em regiões com níveis bons de precipitações, o excesso de água pode afetar diretamente na qualidade dos frutos, deixando a fruta sem sabor por causa da diminuição de açúcares.",
    Solo: "SOLO",
    Paragrafo_melancia_4:" A melancia tem preferência por solo com pH de 5,5 a 7 e saturação de bases 70% (Canal do Horticutor, 2020). Para o cultivo da melancia, recomenda-se solo com textura leve, arenoso, boa porosidade,  sujeito a encharcamento e não compactado.",
    Paragrafo_melancia_5:"Para o preparo do solo, recomenda-se aração profunda, gradagem leve e subsolagem e antes da aração (EMBRAPA, 2007).  Para melhor aproveitamento, as operações devem ser realizadas dois meses antes do plantio, incorporando calcário e magnesio se necessário.",
    Adubacao: "ADUBAÇÃO",
